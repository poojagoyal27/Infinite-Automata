...
-----emptiness (Union (Letter 'a') (Letter 'b'))
-----emptiness (Cat (Letter 'a') (Letter 'b'))
----emptiness (Star (Letter 'r'))




-----unitarity (Letter 'r')
-----unitarity (Union (Letter 'a') (Letter 'b'))
-----unitarity (Cat (Letter 'a') (Letter 'b'))
------unitarity (Star (Letter 'r'))



-----leftquotient 'r' (Empty)
-----leftquotient 'r' (Letter 'r')
-----leftquotient 'r' (Union (Letter 'r') (Letter s'))
-----leftquotient 'r' (Cat (Letter 'r') (Letter 's'))
-----leftquotient 'r' (Star (Letter 'r'))
